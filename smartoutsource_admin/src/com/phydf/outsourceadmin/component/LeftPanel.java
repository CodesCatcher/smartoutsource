...
import com.phydf.outsourceadmin.frames.FrameAddProject;
import com.phydf.outsourceadmin.frames.FrameOutSource;
...
public class LeftPanel extends JPanel {
    ...
    public LeftPanel() {
        ...
        accountTitle = new JLabel("当前帐号：administrator");
        ...
        outpro.addMouseListener(new MouseAdapter() {
            @Override
        ...
        addpro.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                super.mouseClicked(e);
                new FrameAddProject();
    ...
    public void setAccountTitle(String s){
        accountTitle.setText("当前账户:   "+s);
    }
}
